...
const STATUS_COLOR_ROLES = {
  ...
  graphic: {
    ...
    warning: lightDark(palette('yellow', 55), palette('yellow', 80, 'dark')),
    error: lightDark(palette('red', 50), palette('red', 60, 'dark')),
  },
  surface: {
...
export const neutralTheme = defineTheme({
  ...
  components: {
    ...
    // therefore matches Banner/Stepper. Categorical row colors keep their
    // existing categorical icon mappings.
    'table-row-status': {
