...
export const docs = {
  ...
  usage: {
    ...
    bestPractices: [
      ...
      { guidance: true, description: 'For a hierarchical action set that cannot fit as adjacent flyouts on a compact touch surface, a product may explicitly use a drill-in interaction with a Back action.' },
