import{i as e}from"./preload-helper-CT_b8DTk.js";import{t}from"./jsx-runtime-DqZldVDK.js";import{N as n,P as r}from"./iframe-CzePX3qs.js";var i,a,o,s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w;e((()=>{n(),i=t(),a={title:`Core/ProgressBar`,component:r,tags:[`autodocs`],argTypes:{value:{control:{type:`range`,min:0,max:100,step:1},description:`Current value`},max:{control:`number`,description:`Maximum value`},label:{control:`text`,description:`Accessible label`},variant:{control:`select`,options:[`accent`,`success`,`warning`,`error`,`neutral`],description:`Semantic color variant`},contrast:{control:`select`,options:[`standalone`,`supplemental`],description:`Standalone includes its own endpoint cue; supplemental requires an equivalent visible value`},isLabelHidden:{control:`boolean`,description:`Visually hide the label`},hasValueLabel:{control:`boolean`,description:`Show formatted value`},isDisabled:{control:`boolean`,description:`Disabled state (grayed out)`}}},o={args:{value:60,label:`Progress`}},s={args:{value:75,label:`Storage used`,hasValueLabel:!0,contrast:`supplemental`}},c={args:{value:3.2,max:5,label:`Disk usage`,hasValueLabel:!0,contrast:`supplemental`,formatValueLabel:(e,t)=>`${e} GB / ${t} GB`}},l={render:()=>(0,i.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`16px`,width:`300px`},children:[(0,i.jsx)(r,{value:60,label:`Accent`,variant:`accent`,hasValueLabel:!0,contrast:`supplemental`}),(0,i.jsx)(r,{value:80,label:`Success`,variant:`success`,hasValueLabel:!0,contrast:`supplemental`}),(0,i.jsx)(r,{value:50,label:`Warning`,variant:`warning`,hasValueLabel:!0,contrast:`supplemental`}),(0,i.jsx)(r,{value:92,label:`Error`,variant:`error`,hasValueLabel:!0,contrast:`supplemental`}),(0,i.jsx)(r,{value:35,label:`Neutral`,variant:`neutral`,hasValueLabel:!0,contrast:`supplemental`})]})},u={render:()=>(0,i.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`16px`,width:`300px`},children:[(0,i.jsx)(r,{value:30,label:`Upload canceled`,isDisabled:!0,hasValueLabel:!0,contrast:`supplemental`}),(0,i.jsx)(r,{isIndeterminate:!0,label:`Processing disabled`,isDisabled:!0})]})},d={name:`Composed: with description`,render:()=>(0,i.jsxs)(`div`,{style:{width:`300px`},children:[(0,i.jsx)(r,{value:40,max:100,label:`Download progress`,hasValueLabel:!0}),(0,i.jsx)(`div`,{style:{fontSize:`12px`,color:`var(--color-text-secondary)`,marginTop:`4px`},children:`40 MB / 100 MB downloaded`})]})},f={args:{value:50,label:`Loading progress`,isLabelHidden:!0}},p={args:{value:75,label:`Upload`,isLabelHidden:!0,hasValueLabel:!0,contrast:`supplemental`}},m={args:{value:0,label:`Not started`,hasValueLabel:!0,contrast:`supplemental`}},h={args:{value:100,label:`Complete`,hasValueLabel:!0,variant:`success`,contrast:`supplemental`}},g={args:{isIndeterminate:!0,label:`Loading...`}},_={args:{isIndeterminate:!0,label:`Loading`,isLabelHidden:!0}},v={render:()=>(0,i.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`16px`,width:`300px`},children:[(0,i.jsx)(r,{isIndeterminate:!0,label:`Accent`,variant:`accent`}),(0,i.jsx)(r,{isIndeterminate:!0,label:`Success`,variant:`success`}),(0,i.jsx)(r,{isIndeterminate:!0,label:`Warning`,variant:`warning`}),(0,i.jsx)(r,{isIndeterminate:!0,label:`Error`,variant:`error`}),(0,i.jsx)(r,{isIndeterminate:!0,label:`Neutral`,variant:`neutral`})]})},y={args:{value:45,label:`Fundraiser`,hasValueLabel:!0,marks:[{value:80,label:`Goal`}]}},b={args:{value:55,label:`Quarterly milestones`,hasValueLabel:!0,marks:[{value:25,label:`Q1 target`},{value:50,label:`Q2 target`},{value:80,label:`Stretch goal`}]}},x={args:{value:92,label:`Budget used`,hasValueLabel:!0,variant:`warning`,marks:[{value:75,label:`Budget cap`}]}},S={render:()=>{let e=[{value:30,label:`Mark at 30`},{value:85,label:`Mark at 85`}],t={display:`flex`,flexDirection:`column`,gap:`16px`,width:`320px`},n={font:`600 12px/1.4 system-ui, sans-serif`,textTransform:`uppercase`,letterSpacing:`0.06em`,opacity:.6,marginBlockEnd:`-4px`};return(0,i.jsxs)(`div`,{style:{...t,gap:`28px`},children:[(0,i.jsxs)(`div`,{style:t,children:[(0,i.jsx)(`div`,{style:n,children:`Semantic variants — 60% filled`}),[`accent`,`success`,`warning`,`error`,`neutral`].map(t=>(0,i.jsx)(r,{value:60,variant:t,label:t,hasValueLabel:!0,marks:e},t)),(0,i.jsx)(r,{value:60,isDisabled:!0,label:`disabled`,hasValueLabel:!0,marks:e})]}),(0,i.jsxs)(`div`,{style:t,children:[(0,i.jsx)(`div`,{style:n,children:`Fill extremes`}),(0,i.jsx)(r,{value:0,label:`0% — every mark on the track`,hasValueLabel:!0,marks:e}),(0,i.jsx)(r,{value:100,label:`100% — every mark on the fill`,hasValueLabel:!0,marks:e}),(0,i.jsx)(r,{value:30,label:`30% — a mark exactly at the fill edge`,hasValueLabel:!0,marks:e})]}),(0,i.jsxs)(`div`,{style:t,children:[(0,i.jsx)(`div`,{style:n,children:`Indeterminate — marks are ignored`}),(0,i.jsx)(r,{isIndeterminate:!0,label:`indeterminate`,marks:e})]})]})}},C={render:()=>(0,i.jsxs)(`div`,{style:{width:`320px`},children:[(0,i.jsx)(`style`,{children:`
        @layer astryx-theme {
  ...
  render: () => <div style={{
    ...
    width: '300px'
      ...
      <ProgressBar value={60} label="Accent" variant="accent" hasValueLabel contrast="supplemental" />
      <ProgressBar value={80} label="Success" variant="success" hasValueLabel contrast="supplemental" />
      <ProgressBar value={50} label="Warning" variant="warning" hasValueLabel contrast="supplemental" />
      <ProgressBar value={92} label="Error" variant="error" hasValueLabel contrast="supplemental" />
      <ProgressBar value={35} label="Neutral" variant="neutral" hasValueLabel contrast="supplemental" />
    </div>
  ...
  render: () => <div style={{
    ...
    width: '300px'
      ...
      <ProgressBar value={30} label="Upload canceled" isDisabled hasValueLabel contrast="supplemental" />
